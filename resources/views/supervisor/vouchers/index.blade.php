    ...
    <div class="row row-sm">
        <div class="col-xl-12">
            <div class="card">
                ...
                <form action="{{route('select.vouchers')}}" method="post">
                    @csrf
                    @method('POST')
                ...
                <div class="row mt-3 mb-1 text-center justify-content-center align-content-center">
                    <form class="col-3" method="GET" action="{{route('print.selected.vouchers')}}">
                    ...
                    <form class="col-3" method="POST" action="{{route('print.posted.vouchers')}}">
                        @csrf
                    ...
                    <form class="col-3" method="POST" action="{{route('export.vouchers.excel')}}">
                        @csrf
                        @method('POST')
                    ...
                    <div class="col-3">
                        <a href="{{route('supervisor.vouchers.create')}}" role="button"
